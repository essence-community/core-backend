...
select 
	t.ck_id 
from unnest(array[''text'',''date'',''integer'',''numeric'',''boolean'',''textarea'',''custom'']) as t(ck_id)','authcore','-11','2019-08-13 18:30:00.000','select','po_session','Список доступных типов полей')
