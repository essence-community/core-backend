...
--changeset artemov_i:AuthShowAvailableAction.sql dbms:postgresql runOnChange:true splitStatements:false stripComments:false
INSERT INTO s_mt.t_query (ck_id,cc_query,ck_provider,ck_user,ct_change,cr_type,cr_access,cv_description)
VALUES ('AuthShowAvailableAction','/*AuthShowAvailableAction*/
select /*Pagination*/
