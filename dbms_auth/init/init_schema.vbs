...
commadLiquibase = currDir & "\..\gradlew.bat update -PrunList=init -Pliquibase.username=#schemaConnectionAdmin# -Pliquibase.password=#schemaConnectionAdminPw# -Pliquibase.url=#schemaConnection# -Pliquibase.driver=org.postgresql.Driver"
