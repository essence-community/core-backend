...
ALTER SCHEMA pkg_json_user OWNER TO s_ip;
...
ALTER FUNCTION pkg_json_user.f_get_context(pv_attribute character varying) OWNER TO s_ip;
...
ALTER FUNCTION pkg_json_user.f_modify_user(pc_json jsonb, pv_hash character varying) OWNER TO s_ip;
...
ALTER FUNCTION pkg_json_user.f_modify_user_action(pc_json jsonb, pv_hash character varying) OWNER TO s_ip;
...
ALTER FUNCTION pkg_json_user.f_modify_user_department(pc_json jsonb, pv_hash character varying) OWNER TO s_ip;
