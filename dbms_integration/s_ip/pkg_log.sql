...
ALTER SCHEMA pkg_log OWNER TO s_ip;
...
ALTER FUNCTION pkg_log.p_save(pv_user character varying, pv_session character varying, pc_json jsonb, pv_table character varying, pv_id character varying, pv_action character varying) OWNER TO s_ip;
