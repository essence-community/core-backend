...
ALTER SCHEMA pkg OWNER TO s_ip;
...
ALTER FUNCTION pkg.p_form_response() OWNER TO s_ip;
...
ALTER FUNCTION pkg.p_reset_response(pn_user bigint) OWNER TO s_ip;
...
ALTER FUNCTION pkg.p_set_error(pk_id bigint, pv_macro_1 character varying, pv_macro_2 character varying, pv_macro_3 character varying, pv_macro_4 character varying, pv_macro_5 character varying) OWNER TO s_ip;
...
ALTER FUNCTION pkg.p_set_info(pk_id bigint, pv_macro_1 character varying, pv_macro_2 character varying, pv_macro_3 character varying, pv_macro_4 character varying, pv_macro_5 character varying) OWNER TO s_ip;
...
ALTER FUNCTION pkg.p_set_msg_macro(pk_id bigint, pv_macro_1 character varying, pv_macro_2 character varying, pv_macro_3 character varying, pv_macro_4 character varying, pv_macro_5 character varying) OWNER TO s_ip;
...
ALTER FUNCTION pkg.p_set_warning(pk_id bigint, pv_macro_1 character varying, pv_macro_2 character varying, pv_macro_3 character varying, pv_macro_4 character varying, pv_macro_5 character varying) OWNER TO s_ip;
...
ALTER FUNCTION pkg.sp_add(spv_macro character varying) OWNER TO s_ip;
