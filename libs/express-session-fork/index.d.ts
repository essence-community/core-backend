// Type definitions for express-session-fork-fork 1.17
...
declare global {
    namespace Express {
        ...
        interface Request {
             ...
             * Even though this property isn't marked as optional, it won't exist until you use the `express-session-fork-fork` middleware
...
declare namespace session {
    interface SessionOptions {
         ...
         *
         * **If you are using `express-session-fork-fork` in conjunction with PassportJS:**
     ...
     *
     * @example
     * declare module 'express-session-fork-fork' {
