...
(ck_id, ck_class_parent, ck_class_child, ck_class_attr, ck_user, ct_change)
 select t.ck_id, t.ck_class_parent, t.ck_class_child, t.ck_class_attr, t.ck_user, t.ct_change from (
    ...
    union all
    select '345' as ck_id, '35' as ck_class_parent, '35' as ck_class_child, '172' as ck_class_attr, '-11' as ck_user, '2018-02-22T00:00:00.000+0000'::timestamp with time zone as ct_change
    union all
    ...
    union all
    select '8FFC6C4564B94157E053809BA8C00266' as ck_id, '35' as ck_class_parent, '8FFC6C4564B84157E053809BA8C00266' as ck_class_child, '172' as ck_class_attr, '20785' as ck_user, '2019-08-13T00:00:00.000+0000'::timestamp with time zone as ct_change
    union all
    ...
    union all
    select 'D4241C82BFAC41E19AA89693F88EA3D9' as ck_id, '35' as ck_class_parent, 'system:check_list_container' as ck_class_child, '172' as ck_class_attr, '4fd05ca9-3a9e-4d66-82df-886dfa082113' as ck_user, '2021-03-17T08:33:14.574+0000'::timestamp with time zone as ct_change
 ) as t
