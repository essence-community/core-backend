...
INSERT INTO s_mt.t_page_action (ck_id, ck_page, cr_type, cn_action, ck_user, ct_change)VALUES('35C08821AF874B29A27E3DFE9D11CCE2', 'A732E27B938245A9A4A5047B761CD267', 'edit', 99999, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2020-06-15T13:40:37.450+0000') on conflict (ck_id) do update set ck_page = excluded.ck_page, cr_type = excluded.cr_type, cn_action = excluded.cn_action, ck_user = excluded.ck_user, ct_change = excluded.ct_change;
INSERT INTO s_mt.t_page_action (ck_id, ck_page, cr_type, cn_action, ck_user, ct_change)VALUES('191B1B6CD1514B1185A4971A4F22ECB8', 'A732E27B938245A9A4A5047B761CD267', 'view', 99999, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2020-06-15T13:40:37.450+0000') on conflict (ck_id) do update set ck_page = excluded.ck_page, cr_type = excluded.cr_type, cn_action = excluded.cn_action, ck_user = excluded.ck_user, ct_change = excluded.ct_change;
