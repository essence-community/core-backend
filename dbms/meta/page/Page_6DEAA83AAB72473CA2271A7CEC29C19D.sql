...
INSERT INTO s_mt.t_page (ck_id, ck_parent, cr_type, cv_name, cn_order, cl_static, cv_url, ck_icon, ck_view, ck_user, ct_change, cl_menu)VALUES('6DEAA83AAB72473CA2271A7CEC29C19D', 'C0EF204A8D77489FB097AC43A481818D', 2, '4a125d08ddd14845baf3a6983b28a555', 20, 0, null, null, 'system', '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2020-06-17T06:14:46.710+0000', 1) on conflict (ck_id) do update set ck_parent = excluded.ck_parent, ck_view=excluded.ck_view, cr_type = excluded.cr_type, cv_name = excluded.cv_name, cn_order = excluded.cn_order, cl_static = excluded.cl_static, cv_url = excluded.cv_url, ck_icon = excluded.ck_icon, ck_user = excluded.ck_user, ct_change = excluded.ct_change, cl_menu = excluded.cl_menu;
select pkg_patcher.p_merge_page_action('862091079D45471A9BF70E8B1D1C7E50', '6DEAA83AAB72473CA2271A7CEC29C19D', 'edit', 99999, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2020-06-17T06:14:46.710+0000');
select pkg_patcher.p_merge_page_action('1E98F00BF3474DDE9D7FD6C69A8DC48C', '6DEAA83AAB72473CA2271A7CEC29C19D', 'view', 99999, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2020-06-17T06:14:46.710+0000');
