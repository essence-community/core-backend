...
INSERT INTO s_mt.t_page (ck_id, ck_parent, cr_type, cv_name, cn_order, cl_static, cv_url, ck_icon, ck_user, ct_change, cl_menu, ck_view) VALUES('E9F077F939534E2D915E368197982A1F', null, 3, '388fe161ff6f4ddcb3d1e1f7ff578728', 10, 1, 'docs', null, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2021-05-05T12:01:51.162+0300', 0, 'docs') on conflict (ck_id) do update set ck_parent = excluded.ck_parent, cr_type = excluded.cr_type, cv_name = excluded.cv_name, cn_order = excluded.cn_order, cl_static = excluded.cl_static, cv_url = excluded.cv_url, ck_icon = excluded.ck_icon, ck_user = excluded.ck_user, ct_change = excluded.ct_change, cl_menu = excluded.cl_menu, ck_view = excluded.ck_view;
