...
INSERT INTO s_mt.t_page (ck_id, ck_parent, cr_type, cv_name, cn_order, cl_static, cv_url, ck_icon, ck_view, ck_user, ct_change, cl_menu)VALUES('483653E7F5BC481D86375F5A3C803AC2', '1626AD0E15B446D4B478CCC5AC2B6E60', 2, 'a1af5304b34a44caaf8ee651a2330d36', 1, 1, 'home', '358', 'system', '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2019-11-13T00:00:00.000+0000', 0) on conflict (ck_id) do update set ck_parent = excluded.ck_parent, ck_view=excluded.ck_view, cr_type = excluded.cr_type, cv_name = excluded.cv_name, cn_order = excluded.cn_order, cl_static = excluded.cl_static, cv_url = excluded.cv_url, ck_icon = excluded.ck_icon, ck_user = excluded.ck_user, ct_change = excluded.ct_change, cl_menu = excluded.cl_menu;
select pkg_patcher.p_merge_page_action('2EC6E7461CBD4C208768AF55C35CE99C', '483653E7F5BC481D86375F5A3C803AC2', 'edit', 99999, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2019-11-13T00:00:00.000+0000');
select pkg_patcher.p_merge_page_action('89DADF7246C14095BDBD26E04F5C783B', '483653E7F5BC481D86375F5A3C803AC2', 'view', 99999, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2019-11-13T00:00:00.000+0000');
