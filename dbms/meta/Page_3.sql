...
select pkg_patcher.p_merge_object('AA3742B6B2D04C23AB751B501290B52B', '19', '9F4BA53BAAA740BBBBE4E17EBE3ACB42', 'Top Btn Add Class', 100, null, 'Создание нового класса', '6d12c16cd7fa46579477a107a53f0790', null, null, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2019-12-04T00:00:00.000+0000');
...
select pkg_patcher.p_merge_object('C0E589723932468982092A15976C8BB4', '9', '9F4BA53BAAA740BBBBE4E17EBE3ACB42', 'Name Class', 300, null, 'Наименование класса', '3a0b8d771a0d497e8aa1c44255fa6e83', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('0ACDF60E6F944A6F9A44C59422A7E797', '9', '9F4BA53BAAA740BBBBE4E17EBE3ACB42', 'Description class', 400, null, 'Описание класса', '900d174d0a994374a01b0005756521bc', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('AFCF040CC2044E53BBAF316B35E03EBF', '36', '9F4BA53BAAA740BBBBE4E17EBE3ACB42', 'Check cl_dataset', 500, null, 'Признак выводимого набора данных', 'f64cce7f9dbb4dc4a3d7b6e559ee0c33', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('F31962B0DD5344CAB0E7C5A1C6D48242', '36', '9F4BA53BAAA740BBBBE4E17EBE3ACB42', 'Check cl_final', 600, null, 'Признак самостоятельного заполнения', '787ef6dd2e5b45b6b024f5c20d246ad0', null, null, '-11', '2018-02-23T00:00:00.000+0000');
...
select pkg_patcher.p_merge_object('2872E6B328CA4397A8E81147EFDCBDA7', '8', '7F34DED949DF4E3D8A3C6BD52D726B1C', 'SYS Grid Parent Class << DO NOT CHANGE', 300, 'MTClassParent', 'Таблица родительских связей', '74b6bbae3e254b73ad67adbcf5706187', null, null, '10020788', '2018-03-17T00:00:00.000+0000');
...
select pkg_patcher.p_merge_object('D37EDE722CF34CDBB459521FB353D600', '9', '2872E6B328CA4397A8E81147EFDCBDA7', 'Name Attr', 100, null, 'Наименование атрибута', 'f0fd011269f542e1a1238ec4152015a1', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('B23DA17649564C9B9673AC3A1AA95A24', '19', 'D61761E4F2AA49279A15318CA3F8996F', 'Top Btn Add Attr', 100, null, 'Создание атрибута класса', '3a5239ee97d9464c9c4143c18fda9815', null, null, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2019-12-04T00:00:00.000+0000');
select pkg_patcher.p_merge_object('8F21BF55FAE64AD681DD6D89D26E87BA', '19', '80B4041147E3470FA3C38E55004D160D', 'Top Btn Add Child Class', 100, null, 'Добавление дочерних классов', '3a5239ee97d9464c9c4143c18fda9815', null, null, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2019-12-04T00:00:00.000+0000');
...
select pkg_patcher.p_merge_object('0F17EEABE4C34D6EA801023F37230114', '9', '2872E6B328CA4397A8E81147EFDCBDA7', 'Name Class', 200, null, 'Наименование класса', '3989aec5860044ec80f41db907599238', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('B76C07B8A7C247EDA42C3A7E7265C6DE', '9', '2872E6B328CA4397A8E81147EFDCBDA7', 'Desc Class', 300, null, 'Описание класса', '80c7b0a9f8714587b77391263cffb324', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('4E6AD4BE79284CE4B7BB14F107C835DB', '9', '80B4041147E3470FA3C38E55004D160D', 'Name Attr', 300, null, 'Наименование атрибута', 'c910d06ca25c44ae91d3df5a6713eb6b', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('702A0926012D4AE78B9959485017020B', '9', 'D61761E4F2AA49279A15318CA3F8996F', 'Name Attr', 300, null, 'Наименование', '3a0b8d771a0d497e8aa1c44255fa6e83', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('1E648C1FB7A243649A934C39DAEED002', '9', '80B4041147E3470FA3C38E55004D160D', 'Name Class', 400, null, 'Наименование класса', '3989aec5860044ec80f41db907599238', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('C2F27EE271604FB4AABDB05C890F6FAC', '9', 'D61761E4F2AA49279A15318CA3F8996F', 'Value Attr', 400, null, 'Значение атрибута', '9ee99b546c9d473e9c3e3f1679037cce', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('14E3CF7E0F7C48179E7B318779E4D44D', '36', 'D61761E4F2AA49279A15318CA3F8996F', 'Check cl_required', 450, null, 'Признак обязательности', '648a3805be824b098a1962ce294739d3', null, null, '10020788', '2018-03-17T00:00:00.000+0000');
select pkg_patcher.p_merge_object('3486830584C742A5A870C3CC2941065D', '9', 'D61761E4F2AA49279A15318CA3F8996F', 'Desc Attr', 499, null, 'Описание атрибута', '900d174d0a994374a01b0005756521bc', null, null, '10020788', '2018-03-17T00:00:00.000+0000');
select pkg_patcher.p_merge_object('55CB11FA7ACB47AC9209700901BC0800', '9', '80B4041147E3470FA3C38E55004D160D', 'Desc Class', 500, null, 'Описание класса', '80c7b0a9f8714587b77391263cffb324', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('BD3E264C18504B179BD47C0861737F0D', '9', 'D61761E4F2AA49279A15318CA3F8996F', 'Attr Type', 600, null, 'Attr Type', '85859d9988f64adaa920ef0841f8c030', null, null, '10020788', '2018-03-17T00:00:00.000+0000');
select pkg_patcher.p_merge_object('1A6488D52BDB4FCABFF8AAAE4CA23A29', '8D547C621A02626CE053809BA8C0882B', '814EA6C85CEC4C3E93BB3AAB38AEE22E', 'AttrType Radio', 10, 'MTClassAttrType', 'Тип атрибута', 'cd0d1453f79543b3ac97d22999746807', null, null, '4fd05ca9-3a9e-4d66-82df-886dfa082113', '2019-11-22T00:00:00.000+0000');
select pkg_patcher.p_merge_object('FCBE051AA2A14A63BA6B73379B5B62A0', '31', '395C8390216045F2A51188B8E8C71568', 'Attr Class Field', 100, 'MTClassAttrPlacementList', 'Поле выбора атрибута класса', '8cb45e12f5ac4ea6b10dfee6053fd962', null, null, '20783', '2019-04-29T00:00:00.000+0000');
...
select pkg_patcher.p_merge_object('C2B772CF4C4740EBAC996AD47FA34AE9', '31', '395C8390216045F2A51188B8E8C71568', 'Class Combo Field', 200, 'MTClassList', 'Поле выбора класса', '824267e33f5540688cb966a5272dcf72', null, null, '10028610', '2019-02-06T00:00:00.000+0000');
select pkg_patcher.p_merge_object('5FD84B57C03B4C7CA5B426A621175F86', '19', '395C8390216045F2A51188B8E8C71568', 'BBtn Save Window', 1200, null, 'Сохраняем привязку к дочерним объектам', 'ef1415ca80804e149ceb5356efb2df97', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('411E506D52AC49D683838C2CD9BFBA21', '19', '395C8390216045F2A51188B8E8C71568', 'BBtn Close Window', 1300, null, 'Отмена', '64aacc431c4c4640b5f2c45def57cae9', null, null, '-11', '2018-02-23T00:00:00.000+0000');
