...
select pkg_patcher.p_merge_object('B71EF0C794214B3BA7A49E160B36D373', '19', '912DC90A71BB449181834548E5DDA4EA', 'Add New Attr Btn', 100, null, 'Добавление нового атрибута', 'Создать атрибут', null, null, '10020788', '2018-03-17T00:00:00.000+0000');
...
select pkg_patcher.p_merge_object('F3960DD69A33406B86F92BE05043120B', '9', '912DC90A71BB449181834548E5DDA4EA', 'Name Attr Column', 300, null, 'Наименование атрибута', 'Наименование', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('60E439E451354D51855C0BFA53EC64D0', '9', '912DC90A71BB449181834548E5DDA4EA', 'Desc Attr Column', 400, null, 'Описание атрибута', 'Описание', null, null, '-11', '2018-02-23T00:00:00.000+0000');
select pkg_patcher.p_merge_object('27C9B8FE4A084614A2D253815226A7EE', '9', '912DC90A71BB449181834548E5DDA4EA', 'Attr Type', 10000, null, 'Attr Type', 'Тип атрибута', null, null, '-11', '2018-02-23T00:00:00.000+0000');
...
select pkg_patcher.p_merge_object_attr('67407257321', '7C45F172197C4BCDE053809BA8C030D5', '1997', 'Сохранить изменения?', '20780', '2018-12-14T00:00:00.000+0000');
