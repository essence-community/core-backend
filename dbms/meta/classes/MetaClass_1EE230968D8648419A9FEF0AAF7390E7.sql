...
select pkg_patcher.p_clear_attr('1EE230968D8648419A9FEF0AAF7390E7'::varchar, '["actiongate","activerules","childs","childwindow","defaultvalue","defaultvaluelocalization","getmastervalue","idproperty","redirecturl","setrecordtoglobal","type"]'::jsonb);
