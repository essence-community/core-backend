...
--changeset artemov_i:t_icon_mdi_clean dbms:postgresql splitStatements:false stripComments:false
DELETE FROM s_mt.t_icon
	WHERE ck_id='7B21AB0AE4BC446488FDBCDE31972ADC';
DELETE FROM s_mt.t_icon
	WHERE ck_id='9A57B1FBC14C42A7AE4E4F1B8D9EDF3F';
DELETE FROM s_mt.t_icon
	WHERE ck_id='314474FB0336423FB095B6596DAD2C5A';
DELETE FROM s_mt.t_icon
	WHERE ck_id='5D62F0B9D75144E88343DA31A257DFD0';
DELETE FROM s_mt.t_icon
	WHERE ck_id='958A39E3960B425F9DF0976FCF26B76B';
DELETE FROM s_mt.t_icon
	WHERE ck_id='4D20B68499124AFDBDDAED69169018FE';
DELETE FROM s_mt.t_icon
	WHERE ck_id='BD01AA2C318740C5BDEB87EC33A3AFC0';
DELETE FROM s_mt.t_icon
	WHERE ck_id='A04F14863A4444BC8A8539FF681A84BD';
DELETE FROM s_mt.t_icon
	WHERE ck_id='028E824AB94C450F8001E15EDF89D784';
DELETE FROM s_mt.t_icon
	WHERE ck_id='A8507AC0264D441DB1768D362A955803';
DELETE FROM s_mt.t_icon
	WHERE ck_id='8EFA633CA78A4953BB87B1403E55BE55';
DELETE FROM s_mt.t_icon
	WHERE ck_id='A6B4623E3AE54088B30D69A82E978F77';
DELETE FROM s_mt.t_icon
	WHERE ck_id='01A68D43E2404DA2B0CE8127E407D015';
DELETE FROM s_mt.t_icon
	WHERE ck_id='8882234DE71D46A095E9DC5779F9C3A2';
DELETE FROM s_mt.t_icon
	WHERE ck_id='0CDBDFB5BF08498DA8AF092CE1337B99';
DELETE FROM s_mt.t_icon
	WHERE ck_id='9CD34DE5D5534337A2FD25E520596752';
DELETE FROM s_mt.t_icon
	WHERE ck_id='C770067C27EA477FA3D0B6D0DF999BAE';
DELETE FROM s_mt.t_icon
	WHERE ck_id='D1CD5843EE4C4D4C97C516666045E221';
DELETE FROM s_mt.t_icon
	WHERE ck_id='87805310582B4BF694AD36DF786A619F';
DELETE FROM s_mt.t_icon
	WHERE ck_id='A3A4A7C99A474A32A0025FBDC8FDC03C';
DELETE FROM s_mt.t_icon
	WHERE ck_id='01F1C40CB23E4D85863464E32E0D3B82';
DELETE FROM s_mt.t_icon
	WHERE ck_id='F1F9C103A0174108A11A3D90E24513C4';
DELETE FROM s_mt.t_icon
	WHERE ck_id='A51CE79573D342ED9BE5884706B30FD5';
DELETE FROM s_mt.t_icon
	WHERE ck_id='3A51ABA651DA49369ED36E5C748A6B63';
DELETE FROM s_mt.t_icon
	WHERE ck_id='CA54A5BB91F64FC38FB767659C87A1E0';
DELETE FROM s_mt.t_icon
	WHERE ck_id='7BBD40A58B7E47B4A727FBBC85730727';
DELETE FROM s_mt.t_icon
	WHERE ck_id='7C993F28A6A949D191FB9A28141DC716';
DELETE FROM s_mt.t_icon
	WHERE ck_id='E33BDD45A36D458A84F819580130F187';
DELETE FROM s_mt.t_icon
	WHERE ck_id='04697BCDC37745D3899E96125A564EB7';
DELETE FROM s_mt.t_icon
	WHERE ck_id='232244AEDB294B53AAF9F08CE9146138';
DELETE FROM s_mt.t_icon
	WHERE ck_id='68E71E5029C149E5B87FBCCD9D406723';
DELETE FROM s_mt.t_icon
	WHERE ck_id='88DDD1134F8E4CE4997FA3F13805D81A';
DELETE FROM s_mt.t_icon
	WHERE ck_id='A16A077C8B5E4D89AC033FD4A16DD922';
DELETE FROM s_mt.t_icon
	WHERE ck_id='5885AC6AC1EA4EF1A23B14B9B784BE46';
DELETE FROM s_mt.t_icon
	WHERE ck_id='C343C05F05064CF9B604615DEF6D71D4';
DELETE FROM s_mt.t_icon
	WHERE ck_id='8528F4081B0A45A196285A7E80653F9B';
DELETE FROM s_mt.t_icon
	WHERE ck_id='C8DF58F26D2B4D488767E6E3E0268670';
DELETE FROM s_mt.t_icon
	WHERE ck_id='E585EEB968AA4D11ACFA350460C62167';
DELETE FROM s_mt.t_icon
	WHERE ck_id='AE359F3DD188454EA104EC75859794EE';
DELETE FROM s_mt.t_icon
