...
const formatPageSqlPostgres =
    "INSERT INTO s_mt.t_page (ck_id, ck_parent, cr_type, cv_name, cn_order, cl_static, cv_url, ck_icon, ck_user, ct_change, cl_menu, ck_view, cv_redirect_url, cl_multi)" +
...
export class Page extends IRowPatch {
    public toRow(): string {
        return format(
            ...
            this.toStringOrNull("cv_redirect_url"),
            this.row.cl_multi,
        );
    }
}
